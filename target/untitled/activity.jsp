...
<script>
    ...
    $(function (){
        $(document).ready(function (){
            $.post("${pageContext.request.contextPath}/ActivityServlet",function (data){
                function CreateList(){
                ...
                function ResetList(){
                    ...
                    for (let i = 0; i < 17; i++){
                        // console.log(news[i]);
                        let re=news[i];
                        hrefs[i].setAttribute("href",re.Activity_URL);
                        titles[i].innerText=re.Activity_TITLE;
                        texts[i].innerText=re.Activity_ABSTRACT;
                        times[i].innerText=re.Activity_DATE;
                    }
                }
                // RecreateNewsTable()
                CreateList()
